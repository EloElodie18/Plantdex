...
export class PageHomeComponent implements OnInit {
  ...
  plantsToDisplay: Plant[] = []; //propriété que je nomme qui declare mon tableau

  constructor(private plantsService: PlantsService) {}

  ngOnInit(): void { //implementation qui permet un affichage des que le composant se lance
